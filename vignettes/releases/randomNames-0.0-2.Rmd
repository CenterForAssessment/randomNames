...
We're pleased to announce the second release of the **randomNames** package. The package isn't availabe on [CRAN](https://CRAN.R-project.org/package=randomNames)
